	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        'This where the app component is'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_weather = __webpack_require__(260);
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case _index.FETCH_WEATHER:
	      ...
	      var newstate = [action.payload.data].concat(_toConsumableArray(state));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API_KEY = "be4ee99d0e89b51b48b96faeeb90fff0";
	...
	function fetchWeather(city) {
	  var url = ROOT_URL + '&q=' + city + ',us&mode=json';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createError = __webpack_require__(274);
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(279);
